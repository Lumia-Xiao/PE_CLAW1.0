...
def run_buck_design(request: BuckDesignRequest, *, output_root: Path | None = None, enable_magnetic_design: bool = False, llc_search_mode: str = "fast") -> DesignResultResponse:
    ...
    report = run_full_pipeline(plugin, raw_input=raw, include_waveforms=False, output_root=output_root, pipeline_options=PipelineOptions(enable_magnetic_design=enable_magnetic_design), llc_search_mode=llc_search_mode)
