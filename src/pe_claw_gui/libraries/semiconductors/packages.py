...
_PACKAGE_LIBRARY: tuple[SemiconductorPackageTemplate, ...] = (
    ...
    SemiconductorPackageTemplate(
        canonical_name="wolfspeed_sic_half_bridge_module",
        aliases=("Wolfspeed SiC half-bridge module", "Wolfspeed-SiC-half-bridge-module"),
        package_family="power-module",
        body_width_mm=80.0,
        body_height_mm=53.0,
        body_thickness_mm=17.0,
        lead_count=6,
        mounting_style="module",
        lead_style="terminal-blocks",
        tab_cue="baseplate",
        ...
        lead_width_mm=6.0,
        lead_length_mm=8.0,
        datasheet_basis="First-pass Wolfspeed SiC module outline; runtime module dimensions override this template when available.",
    ),
    SemiconductorPackageTemplate(
