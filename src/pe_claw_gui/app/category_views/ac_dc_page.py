"""AC-DC category placeholder page."""
...
class ACDCCategoryPage(ttk.Frame):
    """Safe placeholder for future AC-DC topology selection."""
    ...
    def __init__(self, parent, on_back) -> None:
        ...
        ttk.Label(
            self,
            text="No AC-DC topologies are connected yet. This category is reserved for future implementations.",
            justify="left",
            wraplength=520,
