"""Buck synchronous-rectified topology form widget."""
...
class BuckSynchronousRectifiedUnidirectionalForm(BaseTopologyForm):
    """Input form for Buck Synchronous Rectified Unidirectional."""
    ...
    design_fields = (
        TopologyField("vin_min", "Vin min [V]", "36"),
        TopologyField("vin_max", "Vin max [V]", "60"),
        TopologyField("vout", "Vout [V]", "12"),
        TopologyField("pout", "Pout [W]", "120"),
        TopologyField("fs_khz", "Switching frequency [kHz]", "100"),
        TopologyField("ripple_current_ratio", "Inductor ripple ratio Delta iL/Iout", "0.30"),
    ...
    def __init__(
        ...
        ttk.Label(
            notes,
            text=(
                "This topology represents synchronous rectification with continuous-current treatment.\n\n"
                "Inductor current may cross zero and become negative.\n\n"
                "No diode freewheel or DCM mode switching is used in this model."
            ),
            justify="left",
