"""Buck-Boost diode-rectified topology form widget."""
...
class BuckBoostDiodeRectifiedUnidirectionalForm(BaseTopologyForm):
    """Input form for the inverting diode-rectified Buck-Boost topology."""
    ...
    design_fields = (
        ...
        TopologyField("vout", "Vout magnitude [V]", "24"),
    ...
    def __init__(
        ...
        ttk.Label(
            notes,
            text=(
                "This is the classical inverting Buck-Boost topology.\n\n"
                "The entered Vout value is treated as output-voltage magnitude for design purposes.\n\n"
                "Runtime supports automatic CCM/DCM operating-point detection.\n\n"
                "Light-load DCM may occur, and DCM waveform generation includes a zero-current interval."
            ),
            justify="left",
