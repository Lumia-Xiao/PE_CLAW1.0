"""Boost diode-rectified topology form widget."""
...
class BoostDiodeRectifiedUnidirectionalForm(BaseTopologyForm):
    """Input form for Boost Diode Rectified Unidirectional."""
    ...
    def __init__(
        ...
        ttk.Label(
            notes,
            text=(
                "Supports automatic CCM/DCM operating-point detection.\n\n"
                "Light-load DCM may occur.\n\n"
                "Diode conduction and 3-segment DCM waveform behavior are modeled when applicable."
            ),
            justify="left",
