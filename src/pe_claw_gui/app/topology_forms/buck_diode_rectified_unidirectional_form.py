...
class BuckDiodeRectifiedUnidirectionalForm(BaseTopologyForm):
    """Input form for Buck Diode Rectified Unidirectional."""
    ...
    def __init__(
        ...
        ttk.Label(
            notes,
            text=(
                "This is the only fully implemented topology.\n\n"
                "Use Run Design first, then optionally generate steady-state waveforms "
                "for a selected operating point.\n\n"
                "The runtime automatically resolves CCM or DCM from the requested "
                "Vin and load ratio."
            ),
            justify="left",
