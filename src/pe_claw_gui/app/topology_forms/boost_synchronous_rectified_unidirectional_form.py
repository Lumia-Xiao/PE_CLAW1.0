"""Boost synchronous-rectified topology form widget."""
...
class BoostSynchronousRectifiedUnidirectionalForm(BaseTopologyForm):
    """Input form for Boost Synchronous Rectified Unidirectional."""
    ...
    def __init__(
        ...
        ttk.Label(
            notes,
            text=(
                "Uses synchronous rectification with an active rectifying path.\n\n"
                "Continuous-current treatment only is used.\n\n"
                "Inductor current may cross zero and become negative.\n\n"
                "No DCM segmentation is used in this simplified synchronous model."
            ),
            justify="left",
