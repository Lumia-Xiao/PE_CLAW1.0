"""Input handling for the unified Buck diode-rectified topology."""
...
BUCK_TOPOLOGY_ID = "buck_diode_rectified_unidirectional"
BUCK_DISPLAY_NAME = "Buck Diode Rectified Unidirectional"
BUCK_LEGACY_KEY = "Buck_CCM_DiodeRectified_Unidirectional"


def build_default_inputs() -> dict[str, str]:
    """Return default raw inputs for the active Buck topology."""
...
def build_spec(raw_input: Mapping[str, str]) -> TopologySpec:
    """Parse and validate raw GUI inputs into a Buck topology spec."""
    try:
        spec = TopologySpec(
        ...
        raise ValueError("All Buck design inputs must be valid numbers.") from exc
