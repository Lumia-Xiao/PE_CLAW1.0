"""Diode Boost topology evaluation."""
...
def evaluate(
    ...
    """Evaluate the diode Boost candidate into a topology summary."""
    summary_lines = [
    ...
    return TopologyResult(
        ...
        notes=[
            "Boost diode rectified unidirectional topology.",
...
def build_report(
    ...
    """Build the runtime design report for the diode Boost plugin."""
    return DesignReport(
        spec=spec,
        candidate=candidate,
        ...
        notes=["Runtime report assembled by the diode-rectified Boost plugin."],
    )
