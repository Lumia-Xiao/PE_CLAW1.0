"""Input handling for the diode-rectified Boost topology."""
...
BOOST_TOPOLOGY_ID = "boost_diode_rectified_unidirectional"
BOOST_DISPLAY_NAME = "Boost Diode Rectified Unidirectional"
BOOST_LEGACY_KEY = "Boost_DiodeRectified_Unidirectional"


def build_default_inputs() -> dict[str, str]:
    """Return default raw inputs for the diode Boost topology."""
...
def build_spec(raw_input: Mapping[str, str]) -> TopologySpec:
    """Parse and validate raw GUI inputs into a diode Boost topology spec."""
    try:
        spec = TopologySpec(
        ...
        raise ValueError("All diode Boost design inputs must be valid numbers.") from exc
