"""Active three-level TZCM fixed-frequency topology plugin."""
...
class ThreeLevelTZCMPlugin(TopologyPlugin):
    """Runtime plugin for ThreeLevelTZCM_FixedFrequency."""
...
PLUGIN = ThreeLevelTZCMPlugin()

__all__ = ["PLUGIN", "ThreeLevelTZCMPlugin", "build_default_inputs"]
