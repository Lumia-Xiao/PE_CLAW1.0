"""Active simplified four-mode four-switch Buck-Boost topology plugin."""
...
class FourSwitchBuckBoostPlugin(TopologyPlugin):
    """Runtime plugin for FourSwitchBuckBoost_SimplifiedFourMode."""
...
PLUGIN = FourSwitchBuckBoostPlugin()

__all__ = ["FourSwitchBuckBoostPlugin", "PLUGIN", "build_default_inputs"]
