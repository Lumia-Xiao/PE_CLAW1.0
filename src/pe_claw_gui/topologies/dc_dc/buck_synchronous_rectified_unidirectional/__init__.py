"""Active Buck synchronous-rectified topology plugin."""
...
from .input_schema import BUCK_DISPLAY_NAME, BUCK_LEGACY_KEY, BUCK_TOPOLOGY_ID, build_default_inputs, build_spec
...
class BuckPlugin(TopologyPlugin):
    """Runtime plugin for Buck_SynchronousRectified_Unidirectional."""

    topology_id: str = BUCK_TOPOLOGY_ID
    display_name: str = BUCK_DISPLAY_NAME
    legacy_key: str = BUCK_LEGACY_KEY
