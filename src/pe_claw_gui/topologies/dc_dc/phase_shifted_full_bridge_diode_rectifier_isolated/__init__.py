"""First-pass PSFB diode-rectifier topology plugin."""
...
from .input_schema import PSFB_DISPLAY_NAME, PSFB_LEGACY_KEY, PSFB_TOPOLOGY_ID, build_default_inputs, build_spec
...
class PhaseShiftedFullBridgeDiodeRectifierIsolatedPlugin(TopologyPlugin):
    """Plugin for the isolated PSFB diode-rectifier first-pass path."""

    topology_id: str = PSFB_TOPOLOGY_ID
    display_name: str = PSFB_DISPLAY_NAME
    legacy_key: str = PSFB_LEGACY_KEY
...
PLUGIN = PhaseShiftedFullBridgeDiodeRectifierIsolatedPlugin()
...
__all__ = [
    ...
    "PSFB_TOPOLOGY_ID",
    "PLUGIN",
    "PhaseShiftedFullBridgeDiodeRectifierIsolatedPlugin",
