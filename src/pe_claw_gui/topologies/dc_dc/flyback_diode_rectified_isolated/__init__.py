"""First-pass isolated diode-rectified flyback topology plugin."""
...
from .input_schema import FLYBACK_DISPLAY_NAME, FLYBACK_LEGACY_KEY, FLYBACK_TOPOLOGY_ID, build_default_inputs, build_spec
...
class FlybackDiodeRectifiedIsolatedPlugin(TopologyPlugin):
    """Runtime plugin for the first-pass isolated diode flyback model."""

    topology_id: str = FLYBACK_TOPOLOGY_ID
    display_name: str = FLYBACK_DISPLAY_NAME
    legacy_key: str = FLYBACK_LEGACY_KEY
...
PLUGIN = FlybackDiodeRectifiedIsolatedPlugin()

__all__ = [
    "FLYBACK_DISPLAY_NAME",
    "FLYBACK_LEGACY_KEY",
    "FLYBACK_TOPOLOGY_ID",
    "FlybackDiodeRectifiedIsolatedPlugin",
    "PLUGIN",
