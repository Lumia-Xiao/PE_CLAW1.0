"""Active inverting Buck-Boost diode-rectified topology plugin."""
...
from .input_schema import (
    BUCK_BOOST_DISPLAY_NAME,
    BUCK_BOOST_LEGACY_KEY,
    BUCK_BOOST_TOPOLOGY_ID,
...
class BuckBoostPlugin(TopologyPlugin):
    """Runtime plugin for BuckBoost_DiodeRectified_Unidirectional."""

    topology_id: str = BUCK_BOOST_TOPOLOGY_ID
    display_name: str = BUCK_BOOST_DISPLAY_NAME
    legacy_key: str = BUCK_BOOST_LEGACY_KEY
...
PLUGIN = BuckBoostPlugin()

__all__ = ["BuckBoostPlugin", "PLUGIN", "build_default_inputs"]
