"""Single-phase diode bridge rectifier with DC-link capacitor filter."""
...
class SinglePhaseDiodeBridgeRectifierCapacitorFilterPlugin(TopologyPlugin):
    """Runtime plugin for the Phase 1 AC-DC diode bridge rectifier."""
...
PLUGIN = SinglePhaseDiodeBridgeRectifierCapacitorFilterPlugin()
...
__all__ = [
    ...
    "PLUGIN",
    "TOPOLOGY_ID",
    "SinglePhaseDiodeBridgeRectifierCapacitorFilterPlugin",
    ...
    "extract_stress",
    "generate_waveforms",
    "simulate_diode_bridge_capacitor_input",
    "synthesize",
]
