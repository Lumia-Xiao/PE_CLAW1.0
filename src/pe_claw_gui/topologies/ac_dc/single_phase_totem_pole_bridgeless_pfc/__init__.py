"""Single-phase Totem-Pole Bridgeless PFC first-pass topology plugin."""
...
class SinglePhaseTotemPoleBridgelessPFCPlugin(TopologyPlugin):
    """Executable first-pass Totem-Pole PFC topology."""
...
PLUGIN = SinglePhaseTotemPoleBridgelessPFCPlugin()
...
__all__ = [
    ...
    "PLUGIN",
    "TOPOLOGY_ID",
    "SinglePhaseTotemPoleBridgelessPFCPlugin",
