"""Three-phase two-level voltage-source inverter first-pass topology."""
...
from .synthesizer import calculate_three_phase_two_level_voltage_source_inverter, synthesize
from .waveform import generate_waveforms


@dataclass(frozen=True)
class ThreePhaseTwoLevelVoltageSourceInverterPlugin(TopologyPlugin):
    """Runtime plugin for first-pass three-phase two-level inverter synthesis."""
...
PLUGIN = ThreePhaseTwoLevelVoltageSourceInverterPlugin()
...
__all__ = [
    ...
    "PLUGIN",
    "TOPOLOGY_ID",
    "ThreePhaseTwoLevelVoltageSourceInverterPlugin",
    "build_default_inputs",
    "build_spec",
    "calculate_three_phase_two_level_voltage_source_inverter",
    "evaluate",
    "extract_stress",
    "generate_waveforms",
    "synthesize",
