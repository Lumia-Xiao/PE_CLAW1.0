"""Input handling for the three-phase two-level voltage-source inverter."""
...
def build_default_inputs() -> dict[str, str]:
    """Return default raw inputs for first-pass three-phase inverter design."""
...
def build_spec(raw_input: Mapping[str, str]) -> TopologySpec:
    """Parse and validate raw GUI inputs into a three-phase inverter spec."""
    ...
    try:
        ...
        metadata = merge_ambient_metadata(
            {
                ...
                "modulation": "spwm",
                "dc_link_capacitor_basis": "three-phase first-pass switching-ripple proxy",
            },
            raw_input,
        )
        ...
        raise ValueError("All three-phase inverter design inputs must be valid numbers.") from exc
