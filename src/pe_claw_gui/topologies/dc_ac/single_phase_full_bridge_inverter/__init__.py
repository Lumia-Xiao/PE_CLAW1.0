"""Single-phase full-bridge inverter first-pass topology."""
...
from .synthesizer import (
    calculate_series_rl_open_loop_operating_point,
    calculate_single_phase_full_bridge_inverter,
    calculate_unipolar_spwm_local_ripple_metrics,
    synthesize,
)
...
class SinglePhaseFullBridgeInverterPlugin(TopologyPlugin):
    """Runtime plugin for first-pass full-bridge inverter synthesis."""
...
PLUGIN = SinglePhaseFullBridgeInverterPlugin()
...
__all__ = [
    ...
    "PLUGIN",
    "TOPOLOGY_ID",
    "SinglePhaseFullBridgeInverterPlugin",
